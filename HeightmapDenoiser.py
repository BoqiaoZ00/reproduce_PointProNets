...
class AdvancedEquivariantDenoiser(torch.nn.Module):
    """
    Minimal working equivariant denoiser - trivial representations only
    Now with rotation AND reflection equivariance
    """

    def __init__(self, in_channels=1, num_layers=10, num_feat=128):
        super().__init__()

        # CHANGED: Use flipRot2dOnR2 instead of rot2dOnR2
        # This adds reflection equivariance in addition to rotation equivariance
        self.r2_act = flipRot2dOnR2(N=-1, maximum_frequency=1, axis=np.pi/2)
